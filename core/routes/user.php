...
Route::namespace('User\Auth')->name('user.')->middleware('guest')->group(function () {
    Route::controller('LoginController')->group(function () {
        ...
        // Login OTP routes
        Route::get('login/otp/select', 'showLoginOtpSelect')->name('login.otp.select');
        Route::post('login/otp/send', 'sendLoginOtp')->name('login.otp.send');
        Route::get('login/otp/verify', 'showLoginOtpVerify')->name('login.otp.verify');
        Route::post('login/otp/verify', 'verifyLoginOtp')->name('login.otp.submit');
    });
    ...
    Route::middleware(['check.status', 'registration.complete', 'autoLogout'])->group(function () {
        ...
        Route::namespace('User')->group(function () {
            ...
            Route::controller('UserController')->group(function () {
                ...
                Route::post('twofactor/method/update', 'update2faMethod')->name('twofactor.method.update');
