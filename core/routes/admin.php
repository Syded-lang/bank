...
Route::middleware('admin', 'adminPermission')->group(function () {
    ...
    Route::name('withdraw.')->prefix('withdraw')->group(function () {
        ...
        // Crypto Withdrawal Processing (NOWPayments)
        Route::controller('NowPaymentsController')->prefix('crypto')->name('crypto.')->group(function () {
            Route::post('process', 'processCryptoWithdrawal')->name('process');
            Route::get('status/{id}', 'checkPayoutStatus')->name('status');
    ...
    Route::controller('ReportController')->prefix('report')->name('report.')->group(function () {
        ...
        Route::post('transaction/update-date', 'updateTransactionDate')->name('transaction.update.date');
