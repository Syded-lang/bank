...
@section('panel')
    @php
        ...
        $action = [
            'name' => 'Action',
            'style' => 'dropdown',
            'show' => can('admin.users.detail') || can('admin.users.kyc.details') || can('admin.users.users.login') || can('admin.report.login.history') || can('admin.users.notification.log') || can('admin.users.notification.single'),
            'buttons' => [
                [
                    'name' => 'View Details',
                ...
                [
                    'name' => 'Login As User',
                    'link' => 'route("admin.users.users.login", $item->id)',
                    'show' => can('admin.users.users.login'),
                    'attributes' => [
