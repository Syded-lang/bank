                            ...
                            <div class="list-group list-group-flush">
                                ...
                                @if ($user->branch)
                                    <div class="list-group-item d-flex justify-content-between flex-column flex-wrap border-0">
                                        ...
                                        <h6>{{ $user->branchStaff ? $user->branchStaff->name : 'N/A' }} </h6>
                                    </div>
                                @endif
...
@can('admin.users.users.login')
    @push('breadcrumb-plugins')
        <a href="{{ route('admin.users.users.login', $user->id) }}" target="_blank" class="btn btn-sm btn-outline--primary"><i class="las la-sign-in-alt"></i>@lang('Login as User')</a>
    @endpush
@endcan
